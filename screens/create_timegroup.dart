...
class CreateTimeGroup extends StatefulWidget {
  @override
  _CreateTimeGroupState createState() => _CreateTimeGroupState();
}

class _CreateTimeGroupState extends State<CreateTimeGroup> {
  String name;
  String description;
  ...
  void _saveForm() async {
    if (_form.currentState.validate()) {
      await TimeGroup.saveGroup(
          new TimeGroup.fromForm(this.name, this.description));
